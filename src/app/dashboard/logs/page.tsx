...
const LOGS = [
  {
    id: "l1",
    timestamp: "Apr 12, 2025 14:32 UTC",
    user: "Ade Okafor",
    action: "Withdrawal Requested",
    resource: "Withdrawal",
    detail: "Requested ₦50,000 to GTBank",
    ip: "102.89.42.15",
  },
  {
    id: "l2",
    timestamp: "Apr 12, 2025 10:15 UTC",
    user: "Chioma Eze",
  ...
  {
    id: "l3",
    timestamp: "Apr 12, 2025 09:48 UTC",
    user: "Ngozi Adeyemi",
    action: "Payment Made",
    resource: "Payment",
    detail: "Paid ₦10,000 for Python for Data Science (Kunle)",
    ip: "102.89.18.7",
  },
  {
    id: "l4",
    timestamp: "Apr 11, 2025 22:03 UTC",
    user: "Admin",
    action: "User Suspended",
    resource: "User",
    detail: "Suspended Emeka Nwosu",
    ip: "10.0.1.1",
  },
  {
    id: "l5",
    timestamp: "Apr 11, 2025 16:20 UTC",
    user: "Fatima Bello",
    action: "Course Published",
    resource: "Course",
    detail: "Published 'Python for Data Science'",
    ip: "102.89.55.9",
  },
  {
    id: "l6",
    timestamp: "Apr 11, 2025 12:44 UTC",
    user: "Ibrahim Musa",
    action: "Community Created",
    resource: "Community",
    detail: "Created 'Backend Gurus'",
    ip: "102.89.41.72",
  },
  {
    id: "l7",
    timestamp: "Apr 10, 2025 15:30 UTC",
    user: "Emeka Nwosu",
    action: "Login Failed",
    resource: "Auth",
    detail: "Multiple failed attempts from new device",
    ip: "197.210.54.88",
  },
  {
    id: "l8",
    timestamp: "Apr 10, 2025 09:12 UTC",
    user: "Ade Okafor",
    action: "Member Approved",
    resource: "Community",
    detail: "Approved Chioma Eze into Frontend Devs",
    ip: "102.89.42.15",
  },
];
                ...
                {filtered.map((l) => (
                  <tr key={l.id} className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3">
                      <Badge
                        className={cn(
                          "rounded-full text-[10px] px-2 py-0 h-5 whitespace-nowrap",
                    ...
                    <td className="px-4 py-3 text-xs text-muted-foreground text-right hidden lg:table-cell font-mono">
                      {l.ip}
                    </td>
                  </tr>
                ))}
