...
const PAYMENT_HISTORY = [
  {
    id: "ph1",
    date: "Apr 10, 2025",
    desc: "React for Designers (Enrollment)",
    amount: "₦0",
    student: "Temi Adebayo",
  ...
  },
  {
    id: "ph2",
    date: "Apr 5, 2025",
    desc: "UI/UX Research Methods (Enrollment)",
    amount: "₦0",
    status: "success" as const,
    method: "—",
    receipt: true,
  },
  {
    id: "ph3",
    date: "Mar 28, 2025",
    desc: "Data Science Lab (Subscription)",
    amount: "₦5,000",
    status: "success" as const,
    method: "Paystack ·••4242",
    receipt: true,
  },
  {
    id: "ph4",
    date: "Mar 15, 2025",
    desc: "Advanced TypeScript (One-time)",
    amount: "₦15,000",
    status: "success" as const,
    method: "Flutterwave ·••8901",
    receipt: true,
  },
  {
    id: "ph5",
    date: "Mar 1, 2025",
    desc: "Freelance Blueprint (Payment)",
    amount: "₦8,000",
...
const PARENT_PAYMENT_HISTORY = [
  ...
  },
  {
    id: "pp4",
    date: "Jan 20, 2025",
    desc: "Mathematics Tutoring (Monthly)",
    amount: "₦3,000",
    student: "Temi Adebayo",
    status: "success" as const,
    method: "Paystack ·••4242",
          ...
          <div className="-mb-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 px-5 py-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                You now have access. Happy learning!
              </p>
            </div>
            <Button
              size="sm"
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-muted/30 text-xs text-muted-foreground">
                    <th className="text-left pl-5 pr-3 py-3 font-medium">
                      Date
                    </th>
                    ...
                    <th className="text-right pl-3 pr-5 py-3 font-medium">
                      Receipt
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {history.map((p) => (
                    <tr key={p.id} className="hover:bg-muted/20">
                      <td className="pl-5 pr-3 py-3 text-xs text-muted-foreground">
                        {p.date}
                      </td>
                      ...
                      <td className="px-3 py-3">
                        <Badge
                          className={`rounded-full text-[10px] px-2 py-0 h-5 ${statusColors[p.status]}`}
                        >
                          {p.status}
                        </Badge>
                      </td>
            ...
            {SUBSCRIPTIONS.map((s) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {s.amount}/{s.cycle.toLowerCase()} · Next billing{" "}
                    {s.nextBilling}
                  </p>
                  {s.status === "past_due" && (
                    <p className="text-xs text-red-600 mt-1 flex items-center gap-1">
                      <HugeiconsIcon
                        ...
                        className="shrink-0"
                      />{" "}
                      Payment failed. Update within {s.graceDays} days to keep
                      access.
                    </p>
                  )}
                </div>
                <div className="flex items-center gap-2 shrink-0">
                  <Badge
                    className={`rounded-full text-[10px] px-2 py-0 h-5 ${s.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}
                  >
