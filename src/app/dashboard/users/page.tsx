            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-muted/30 text-xs text-muted-foreground">
                  ...
                  <th className="text-left px-2 py-3 font-medium hidden sm:table-cell">
                    Joined
                  </th>
                  <th className="text-left px-2 py-3 font-medium hidden md:table-cell">
                    Last Active
                  </th>
                  <th className="text-right pl-2 pr-4 py-3 font-medium">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y">
                {filtered.map((u) => (
                  <tr
                    ...
                    onClick={() =>
                      router.push(`/dashboard/users/${u.id}?role=${role}`)
                    }
                  >
                      ...
                      >
                        {u.status === "active" && (
                          <Button
                            ...
                            onClick={() =>
                              setActionConfirm({ id: u.id, action: "suspend" })
                            }
                          >
                            Suspend
                          </Button>
                        ...
                        {u.status !== "deleted" && (
                          <Button
                            ...
                            onClick={() =>
                              setActionConfirm({ id: u.id, action: "delete" })
                            }
                          >
                            Delete
                          </Button>
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                className="rounded-full"
                variant={
                  actionConfirm.action === "delete" ? "destructive" : "default"
                }
                onClick={() =>
