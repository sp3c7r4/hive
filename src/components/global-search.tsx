...
const ADMIN_SEARCH: SearchResult[] = [
  {
    ...
    type: "user",
    label: "Ade Okafor",
    sub: "Instructor · ade@hive.ng",
    href: "/dashboard/users/u1",
  },
  {
    id: "au2",
    type: "user",
    label: "Chioma Eze",
    sub: "Student · chioma@hive.ng",
    href: "/dashboard/users/u2",
  },
  {
    id: "au3",
    type: "user",
    label: "Emeka Nwosu",
    sub: "Student · Suspended",
    href: "/dashboard/users/u3",
  },
  {
    id: "au4",
    type: "user",
    label: "Fatima Bello",
    sub: "Instructor · fatima@hive.ng",
    href: "/dashboard/users/u4",
  },
  {
    id: "au5",
    type: "user",
    label: "Ngozi Adeyemi",
    sub: "Parent · ngozi@hive.ng",
    href: "/dashboard/users/u5",
  },
  {
    id: "au6",
    type: "user",
    label: "Ibrahim Musa",
    sub: "Instructor · ibrahim@hive.ng",
    href: "/dashboard/users/u7",
  },
  {
    id: "ap1",
    type: "admin_page",
    label: "All Payments",
    sub: "Monitor transactions",
...
const GENERAL_SEARCH: SearchResult[] = [
  ...
  },
  {
    id: "c5",
    type: "community",
    label: "Mobile Dev Collective",
    sub: "720 members · 9 online",
    href: "/dashboard/communities/mobile-dev/manage",
  },
  /* Courses */
  {
    id: "cr1",
  ...
  },
  {
    ...
    sub: "Intermediate · 6 weeks · ₦40,000",
    href: "/dashboard/courses/typescript-deep",
  },
  /* People */
  {
    id: "p1",
  ...
  },
  {
    ...
    type: "person",
    label: "Prof. Adeyemi",
    sub: "Instructor · Backend",
    href: "/dashboard/profile/adeyemi",
  },
  {
    id: "p6",
    type: "person",
...
const sectionMeta: Record<
  string,
  { icon: typeof Search01Icon; label: string; color: string }
> = {
  community: {
    icon: UserGroupIcon,
    label: "Communities",
  ...
  const results = useMemo(() => {
    ...
    if (isAdmin) {
      return {
        ...
        admin_pages: filtered
          .filter((r) => r.type === "admin_page")
          .slice(0, 4),
      };
    }
    return {
  ...
  return (
    ...
    >
      <Input
        ...
        placeholder={
          isAdmin
            ? "Search users, payments, logs..."
            : "Search communities, courses, people..."
        }
          ...
          {totalResults === 0 ? (
            ...
            <>
              {sectionOrder.map((type) => {
                ...
                const items =
                  (results?.[key as keyof typeof results] as SearchResult[]) ??
                  [];
                ...
                return (
                  <div key={type}>
                    <div className="flex items-center gap-2 px-4 pt-3 pb-1.5">
                      <div
                        className={`size-6 rounded-md flex items-center justify-center shrink-0 ${meta.color}`}
                      >
              ...
              <div className="border-t px-4 py-2.5">
                <button
                  ...
                  onClick={() => {
                    setOpen(false);
                    router.push(
                      `/dashboard/search?q=${encodeURIComponent(query)}${isAdmin ? "&role=admin" : ""}`,
                    );
                  }}
