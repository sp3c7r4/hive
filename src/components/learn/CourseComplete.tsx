  ...
  useGSAP(
    () => {
      ...
      tl.from(".complete-badge", {
        ...
        .from(".complete-text", { y: 20, opacity: 0, duration: 0.4 }, "-=0.2")
        .from(
          ".complete-actions",
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {Array.from({ length: 40 }).map((_, i) => (
          ...
          >
            <div
              className={`w-full h-full rounded-sm ${confettiColors[i % confettiColors.length]}`}
            />
          </div>
        ))}
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-md">
        ...
        <div className="complete-badge size-20 sm:size-24 rounded-full bg-primary/10 flex items-center justify-center mb-4 sm:mb-6">
          <HugeiconsIcon
            icon={Award01Icon}
            size={36}
            className="sm:size-[48px] text-primary"
          />
        </div>
        ...
        <div className="complete-actions flex flex-col items-center gap-2.5 sm:gap-3 mt-6 sm:mt-8 w-full">
          ...
          <Button
            className="rounded-full w-full complete-actions"
            size="lg"
