...
const INITIAL_COMMENTS: Comment[] = [
  {
    ...
    author: { name: "Chioma Eze", initials: "CE" },
    content:
      "Can't wait! Will the workshop be recorded for those who can't join live?",
  ...
  },
  {
    ...
    author: { name: "Emeka Nwosu", initials: "EN" },
    content:
      "Your dark mode transition is smooth! What approach did you use for persisting the preference?",
    createdAt: new Date(Date.now() - 3600000).toISOString(),
  },
  {
    id: "c4",
    ...
    author: { name: "Chioma Eze", initials: "CE" },
    content:
      "Thanks! I used localStorage and a CSS custom property approach — the system preference is the fallback if nothing is saved. Happy to share the code.",
  ...
  },
  {
    ...
    author: { name: "Ade Okafor", initials: "AO", isInstructor: true },
    content:
      "For a mid-size e-commerce dashboard, Zustand is a great choice — minimal boilerplate and easy to colocate state. useReducer works well for complex local state (multi-step forms, wizards). I'd skip Context + useReducer for global state at that scale — the re-render patterns get tricky.",
